package Unsupervised.LaplacianScore;

import unifeat.dataset.DatasetInfo;
import unifeat.featureSelection.filter.unsupervised.LaplacianScore;
import unifeat.util.FileFunc;

public class LaplacianScoreDataset {
    ...
    public static void main(String[] args) {
        ...
        int kNNValue = 5; //the k-nearest neighbor value
        
        //performing the feature selection by laplacian score method
        LaplacianScore method = new LaplacianScore(sizeSelectedFeatureSubset, constant, kNNValue);
